...
namespace Ceto
{
	...
	public class ShipCamera : MonoBehaviour 
	{
		...
		public float m_camRotationSpeed = 5.0f;

		public float m_camStartRotationX = 270.0f;

		public float m_camStartRotationY = 80.0f;

		public float m_camStartDistance = 70.0f;
		...
		public Vector3 scopePosition = new Vector3(0,0,0);
		...
		public void MoveShip()
		{
			...
			if (!isScoped) {
				...
				lookAt = scopePosition;
				pos = lookAt + (new Vector3(sp*st, ct, cp*st));
				transform.position = pos;
				transform.LookAt (lookAt);
			}
